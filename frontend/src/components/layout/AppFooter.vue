      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1">
          <div class="flex items-center space-x-2 mb-4">
            <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
              <span class="text-gray-900 font-bold text-sm">MS</span>
            </div>
            <span class="text-xl font-bold">MicroShop</span>
          </div>
        ...
        <div class="col-span-1">
          ...
          <ul class="space-y-2">
            ...
            <li>
              <router-link to="/catalog" class="text-gray-400 hover:text-white text-sm transition-colors">
                Catalog
              </router-link>
            </li>
            <li>
              <router-link to="/cart" class="text-gray-400 hover:text-white text-sm transition-colors">
                Shopping Cart
              </router-link>
            </li>
            <li>
              <router-link to="/profile" class="text-gray-400 hover:text-white text-sm transition-colors">
                My Account
              </router-link>
            </li>
          </ul>
